            ...
            <div className="card animated fadeInLeft">
                ...
                <form onSubmit={this.continue}>
                    <div className="row col-lg-10 mx-auto">
                        ...
                        <div className="col-lg-4 text-left">
                            <label>Email*</label>
                            <input type="email" name="email" className="form-control" onChange={handleChange}  defaultValue={values.status === 1 ? '' : values.email}  />
                        </div>
                        <div className="col-lg-4 text-left">
                            <label>Mobile*</label>
                            <input type="text" name="phone" className="form-control" onChange={handleChange} defaultValue={values.status === 1 ? '' : values.phone}  />
                        </div>
                    </div>
                    <br />
                    <div className="row col-lg-10 mx-auto">
